...
async fn fetch_territories(territory: &str) -> Vec<Territory> {
    ...
    let url = format!(
        "https://www.eleicoes.mai.gov.pt/legislativas2022/assets/static/territory-children/territory-children-{}.json",
        territory
    );
...
pub struct Legislativas2022;

impl crate::fetch::Source for Legislativas2022 {
    fn name() -> &'static str {
        "raw/legislativas2022"
    }
    ...
    fn request(key: &Self::KeyType) -> reqwest::Request {
        ...
        headers.insert(
            ...
            format!("https://www.eleicoes.mai.gov.pt/legislativas2022/resultados/territorio-nacional?local={}", key)
                .parse()
                .unwrap(),
        );

        client()
            .get(format!("https://www.eleicoes.mai.gov.pt/legislativas2022/assets/static/territory-results/territory-results-{}-AR.json", key))
            .headers(headers)
            .build()
            .unwrap()
    }
