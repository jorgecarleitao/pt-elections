...
, legislativas_2019 AS (
    SELECT
    'legislativas(2019)' AS election,
    territory_type,
    territory,
    'ar' AS organ_type,
    unnest(
    ...
    FROM read_json('s3://pt-elections/processed/legislativas2022/v1/all.json')
)

, legislativas_2022 AS (
    SELECT
    'legislativas(2022)' AS election,
    territory_type,
    territory,
    'ar' AS organ_type,
    unnest(
...
SELECT * FROM legislativas_2019
UNION ALL
SELECT * FROM autarquicas_2021
UNION ALL
SELECT * FROM legislativas_2022
UNION ALL
SELECT * FROM autarquicas_2025
UNION ALL 
SELECT * FROM legislativas_2024
UNION ALL
SELECT * FROM legislativas_2025
