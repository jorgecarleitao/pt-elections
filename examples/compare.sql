...
SELECT
    coalesce(autarquicas_2025.territory_type, legislativas_2025.territory_type, legislativas_2024.territory_type, autarquicas_2021.territory_type) AS 'territory_type',
    coalesce(autarquicas_2025.territory, legislativas_2025.territory, legislativas_2024.territory, autarquicas_2021.territory) AS 'territory',
...
WHERE
    coalesce(legislativas_2025.list, legislativas_2024.list, autarquicas_2025.list, autarquicas_2021.list) = 'L'
    AND coalesce(autarquicas_2025.territory_type, legislativas_2025.territory_type, legislativas_2024.territory_type, autarquicas_2021.territory_type) = 'freguesia'
    AND autarquicas_2025.percentage IS NOT NULL
ORDER BY autarquicas_2025.percentage DESC
